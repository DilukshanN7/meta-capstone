  ...
  return (
    <div className="App">
      ...
      <div className='second'>
        ...
        <div className='third'>
          <div className='card'>
            <img src='1st.png' height={180} width={300}></img>
            <p className='title'>Greek Salad</p>
            <p className='sub'>The famous greek salad of crispy lettuce, peppers, olives and our Chicago style feta cheese, garnished with crunchy garlic and rosemary croutons. </p>
            <p className='footer'>Order Delivery</p>
          </div>
          <div className='card'>
            <img src='2nd.png' height={180} width={300}></img>
            <p className='title'>Lemon Dessert</p>
            <p className='sub'>This comes straight from grandma’s recipe book, every last ingredient has been sourced and is as authentic as can be imagined. </p>
            <p className='footer'>Order Delivery</p>
          </div>
          <div className='card'>
            <img src='3rd.png' height={180} width={300}></img>
            <p className='title'>Bruschetta</p>
            <p className='sub'>Our Bruschetta is made from grilled bread that has been smeared with garlic and seasoned with salt and olive oil. </p>
            <p className='footer'>Order Delivery</p>
          </div>
        </div>
      </div>
